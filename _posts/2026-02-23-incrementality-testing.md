...
description: "Your incrementality test showed Meta drives only 15% incremental lift instead of the 40% it claims. That doesn't mean you should turn it off. Here's how to use incrementality data correctly."
